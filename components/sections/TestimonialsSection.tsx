      ...
      <div className="relative z-10 w-full px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24 2xl:px-36">
        ...
        <div ref={headerRef} className="mb-8 sm:mb-10 xl:mb-14">
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-[#BE9F98] uppercase tracking-widest text-sm sm:text-base font-bold">Happy Clients</span>
          </div>
          <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-light text-[#000000] dark:text-white leading-tight">
