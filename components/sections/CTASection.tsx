      ...
      <div className="container mx-auto px-4 lg:px-12 fade-up w-full py-4 md:py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
          ...
          <div className="bg-white p-4 md:p-6 lg:p-8 border border-brand-black/5 shadow-xl rounded-sm">
            <p className="text-accent uppercase tracking-widest text-[8px] md:text-[9px] lg:text-xs font-bold mb-1.5 md:mb-2">Let&rsquo;s Connect</p>
            ...
            <div className="flex flex-col sm:flex-row gap-2 md:gap-3 mb-4 md:mb-6">
              {[
                ...
                <div key={p.name} className="flex-1 flex items-center gap-2 md:gap-3 border-l-4 border-accent pl-2 md:pl-3 bg-brand-light py-1.5 md:py-2">
                  <img src={p.img} alt={p.name} className="w-8 h-8 md:w-10 md:h-10 object-cover rounded-full shadow-sm" />
                  <div>
                    <div className="text-xs md:text-sm font-bold text-brand-black">{p.name}</div>
                    <div className="text-[8px] md:text-[9px] uppercase tracking-wider text-brand-black/60 mt-0.5">{p.role}</div>
                  </div>
                </div>
              ))}
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-3">
              <a href="tel:+8801774873972" className="flex items-center gap-1.5 md:gap-2 text-brand-black hover:text-accent transition-colors border border-brand-black/5 p-2 md:p-3 rounded-sm">
                ...
                <div className="flex flex-col"><span className="font-medium text-[10px] md:text-xs">+880 1774-873972</span><span className="text-[7px] md:text-[8px] uppercase tracking-wider text-brand-black/50">CEO</span></div>
              </a>
              <a href="tel:01913715734" className="flex items-center gap-1.5 md:gap-2 text-brand-black hover:text-accent transition-colors border border-brand-black/5 p-2 md:p-3 rounded-sm">
                <Phone size={14} className="text-accent shrink-0" />
                <div className="flex flex-col"><span className="font-medium text-[10px] md:text-xs">01913-715734</span><span className="text-[7px] md:text-[8px] uppercase tracking-wider text-brand-black/50">Sales</span></div>
              </a>
              <a href="https://wa.me/8801774873972" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 md:gap-2 text-brand-black hover:text-accent transition-colors border border-brand-black/5 p-2 md:p-3 rounded-sm">
                <MessageCircle size={14} className="text-accent shrink-0" /><span className="font-medium text-[10px] md:text-xs">WhatsApp</span>
              </a>
              <a href="mailto:kazdevelopersteam@gmail.com" className="flex items-center gap-1.5 md:gap-2 text-brand-black hover:text-accent transition-colors border border-brand-black/5 p-2 md:p-3 rounded-sm">
                <Mail size={14} className="text-accent shrink-0" /><span className="font-medium text-[10px] md:text-xs">Email Us</span>
              </a>
            </div>
          </div>
          ...
          <div className="bg-brand-black text-white p-4 md:p-6 lg:p-8 rounded-sm shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col gap-3 md:gap-4 relative z-10">
              ...
              <div className="flex flex-col gap-1 md:gap-1.5">
                ...
                <textarea rows={2} placeholder="Tell us about your land..." className="bg-white/5 border border-white/20 focus:border-accent outline-none text-white px-2.5 md:px-3 py-1.5 md:py-2 rounded-sm transition-colors resize-none text-xs md:text-sm" />
              </div>
