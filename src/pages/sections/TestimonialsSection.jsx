                ...
                <div className="flex flex-col-reverse lg:flex-row gap-3 lg:gap-16 items-center">
                    ...
                    <div className="w-full lg:w-1/3 flex lg:flex-col gap-2 justify-center">
                        {testimonials.map((item, i) => (
                            <button
                                key={i}
                                className={`relative overflow-hidden rounded-full transition-all duration-300 transform outline-none ${i === current ? 'w-10 h-10 lg:w-24 lg:h-24 shadow-xl ring-2 lg:ring-4 ring-accent ring-offset-2 lg:ring-offset-4' : 'w-7 h-7 lg:w-16 lg:h-16 opacity-50 hover:opacity-100 hover:scale-105'}`}
                    ...
                    <div className="w-full lg:w-2/3">
                        ...
                        <h2 className="text-sm lg:text-3xl tracking-tight text-brand-black mb-2 lg:mb-5 font-light leading-tight">
                            What Customers Say About Us
                        </h2>
 
                        <div className="flex gap-1 mb-2 lg:mb-4">
                            {Array.from({ length: t.rating }).map((_, i) => (
                                <Star key={i} size={12} fill="#BE9F98" color="#BE9F98" className="lg:w-5 lg:h-5" />
                            ))}
                        </div>
                        ...
                        <div className="flex items-center gap-3 lg:gap-6">
                            <button className="p-1.5 lg:p-3 rounded-full border border-brand-black/10 hover:bg-brand-black hover:text-white transition-colors text-brand-black" onClick={prev} aria-label="Previous">
                            ...
                            <button className="p-1.5 lg:p-3 rounded-full border border-brand-black/10 hover:bg-brand-black hover:text-white transition-colors text-brand-black" onClick={next} aria-label="Next">
