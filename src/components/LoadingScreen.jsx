...
const LoadingScreen = ({ onComplete }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[99999] bg-brand-light flex flex-col items-center justify-center transition-all duration-700 ease-in-out ${fadeOut ? 'opacity-0 blur-xl pointer-events-none' : 'opacity-100 pointer-events-auto'}`}
    >
